...
/* Scroll Title Begin */
var scrl = "Christmas with you! Thảo ";
function scrlsts() {
            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "Thảo ui,",
                        "Mùa Giáng sinh đã đến rồi, Thảo có khỏe không?",
                        "Chúc mừng em vừa hoàn thành kỳ thi vất vả! Hy vọng rằng những nỗ lực của em sẽ được đền đáp xứng đáng.",
                        "Chào mừng mùa Giáng Sinh đang đến, chúc em và gia đình có những giây phút ấm áp và hạnh phúc bên nhau.",
                        "Mọi khó khăn đã qua, giờ đây hãy thư giãn và tận hưởng những khoảnh khắc trọn vẹn bên gia đình nhaaa.",
                        "Chúc em có một mùa lễ an lành, tràn đầy niềm vui và bình yên!",
                        "Luôn bên em,",
                        "Hoàng Vũ",
                        ],
                        typeSpeed: 70,
